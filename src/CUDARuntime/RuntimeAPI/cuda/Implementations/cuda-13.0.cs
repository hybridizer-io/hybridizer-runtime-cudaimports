...
namespace Hybridizer.Runtime.CUDAImports
{
    ...
    internal unsafe partial class CudaImplem
    {
		...
		public struct cudaDeviceProp_130
		{
        ...
        internal class Cuda_64_130_linux : ICuda
        {
            ...
            public static extern cudaError_t cudaGetDeviceProperties(out cudaDeviceProp_130 props, int device);
            public cudaError_t GetDeviceProperties(out cudaDeviceProp props, int device)
            {
                cudaDeviceProp_130 res;
            ...
            public static extern cudaError_t cudaChooseDevice(out int device, ref cudaDeviceProp_130 prop);
            public cudaError_t ChooseDevice(out int device, ref cudaDeviceProp prop)
            {
                cudaDeviceProp_130 res;
                res = cuda.StructConvert<cudaDeviceProp_130>(prop);
...
#pragma warning restore 0169
        ...
        internal class Cuda_64_130_windows : ICuda
        {
